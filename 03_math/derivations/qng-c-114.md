...
- Treat tau engineering as a controllability hypothesis; separate signal-speed from processing-delay semantics.

## Next Action

- Link QNG-C-114 to 05_validation/test-plan.md with explicit dataset and threshold.
