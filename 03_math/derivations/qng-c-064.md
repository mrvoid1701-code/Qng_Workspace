# QNG-C-064 Derivation

- Claim statement: CTM base relation is T_C = t_R + DeltaL(chi,v) with DeltaL = v tau(chi).
...
- CTM base relation is T_C = t_R + DeltaL(chi,v) with DeltaL = v tau(chi).
...
- Link QNG-C-064 to 05_validation/test-plan.md with explicit dataset and threshold.
