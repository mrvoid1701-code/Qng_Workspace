# QNG-C-048 Derivation

- Claim statement: Quantum behavior emerges near the stability threshold Sigma approximately Sigma_min.
...
```text
P_persist = 1/(1+exp(-beta_q*(Sigma_i-Sigma_min)))
```
...
- Quantum behavior emerges near the stability threshold Sigma approximately Sigma_min.
...
- Link QNG-C-048 to 05_validation/test-plan.md with explicit dataset and threshold.
