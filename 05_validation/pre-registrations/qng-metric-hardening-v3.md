# Pre-Registration - QNG Metric Hardening v3

- Date: 2026-02-21
- Test ID: `QNG-T-METRIC-003`
- Scope: emergent continuous metric hardening from **dynamic Sigma Hessian** estimator with conformal gauge normalization and fixed anisotropy shrinkage
- Lock dependencies:
...
- metric estimator:
  - SPD projection of `-Hessian(Sigma_s)`
  - unit-trace conformal gauge normalization
  - fixed anisotropy shrinkage `k=0.4`
...
- Method changes require `metric-lock-v4.md` + new prereg.
