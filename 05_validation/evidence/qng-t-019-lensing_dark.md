...
- Derivation: `03_math/derivations/qng-c-040.md`
- Test plan source: `05_validation/test-plan.md`
- Evidence file: `05_validation/evidence/qng-t-019-lensing_dark.md`
- Current status: pass
...
# 2) Strict-input production run for QNG-T-019 artifacts
.\.venv\Scripts\python.exe scripts\run_qng_t_027_lensing_dark.py `
  ...
  --out-dir "05_validation/evidence/artifacts/qng-t-019" `
  --seed 42 `
  --strict-input
```
...
| Artifact | Path | Notes |
| --- | --- | --- |
| Run log | `05_validation/evidence/artifacts/qng-t-019/run-log.txt` | Full command line, software versions, timestamps |
| Fit summary table | `05_validation/evidence/artifacts/qng-t-019/fit-summary.csv` | Baseline vs memory metrics |
| Rotation curve overlay | `05_validation/evidence/artifacts/qng-t-019/rotation-overlay.png` | Baseline and memory fit comparison |
| Lensing center-offset plot | `05_validation/evidence/artifacts/qng-t-019/lensing-offsets.png` | Cross-linked lensing consistency diagnostic |
| Parameter stability report | `05_validation/evidence/artifacts/qng-t-019/parameter-stability.md` | Subsample consistency checks |
| Negative-control summary | `05_validation/evidence/artifacts/qng-t-019/negative-controls-summary.csv` | Permutation control gate summary |
| Negative-control run table | `05_validation/evidence/artifacts/qng-t-019/negative-controls-runs.csv` | Per-run control diagnostics |
| Negative-control note | `05_validation/evidence/artifacts/qng-t-019/negative-controls.md` | Human-readable control interpretation |
