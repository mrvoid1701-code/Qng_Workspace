...
- delta_chi2_lens: `-1.488070e+04`
- delta_chi2_rot: `-8.687304e+05`
- delta_chi2_total: `-8.836111e+05`
- delta_aic_total: `-8.836071e+05`
- offset_score: `1.000000`

## Control Gates

- Lensing permutation ratio (median control / positive): `3.161012e-04` (threshold `<= 0.20`) -> `true`
- Rotation permutation ratio (median control / positive): `0.108747` (threshold `<= 0.20`) -> `true`
