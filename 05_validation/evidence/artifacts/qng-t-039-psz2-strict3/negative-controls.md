...
- Lensing permutation ratio (median control / positive): `0.001031` (threshold `<= 0.20`) -> `true`
- Rotation permutation ratio (median control / positive): `0.121095` (threshold `<= 0.20`) -> `true`
