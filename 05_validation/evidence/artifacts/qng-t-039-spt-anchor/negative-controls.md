...
- Lensing permutation ratio (median control / positive): `0.039395` (threshold `<= 0.20`) -> `true`
- Rotation permutation ratio (median control / positive): `0.118496` (threshold `<= 0.20`) -> `true`
