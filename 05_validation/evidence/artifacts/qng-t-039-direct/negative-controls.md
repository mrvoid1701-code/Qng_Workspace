...
- Lensing permutation ratio (median control / positive): `5.875315e-04` (threshold `<= 0.20`) -> `true`
- Rotation permutation ratio (median control / positive): `0.122840` (threshold `<= 0.20`) -> `true`
