...
- Derivation: `03_math/derivations/qng-c-027.md`
- Test plan source: `05_validation/test-plan.md`
- Evidence file: `05_validation/evidence/qng-t-012-lensing_dark.md`
- Current status: pass
...
# 2) Strict-input production run for QNG-T-012 artifacts
.\.venv\Scripts\python.exe scripts\run_qng_t_027_lensing_dark.py `
  ...
  --out-dir "05_validation/evidence/artifacts/qng-t-012" `
  --seed 42 `
  --strict-input
```
...
| Artifact | Path | Notes |
| --- | --- | --- |
| Run log | `05_validation/evidence/artifacts/qng-t-012/run-log.txt` | Full command line, software versions, timestamps |
| Fit summary table | `05_validation/evidence/artifacts/qng-t-012/fit-summary.csv` | Baseline vs memory metrics |
| Rotation curve overlay | `05_validation/evidence/artifacts/qng-t-012/rotation-overlay.png` | Baseline and memory fit comparison |
| Lensing center-offset plot | `05_validation/evidence/artifacts/qng-t-012/lensing-offsets.png` | Cross-linked lensing consistency diagnostic |
| Parameter stability report | `05_validation/evidence/artifacts/qng-t-012/parameter-stability.md` | Subsample consistency checks |
| Negative-control summary | `05_validation/evidence/artifacts/qng-t-012/negative-controls-summary.csv` | Permutation control gate summary |
| Negative-control run table | `05_validation/evidence/artifacts/qng-t-012/negative-controls-runs.csv` | Per-run control diagnostics |
| Negative-control note | `05_validation/evidence/artifacts/qng-t-012/negative-controls.md` | Human-readable control interpretation |
