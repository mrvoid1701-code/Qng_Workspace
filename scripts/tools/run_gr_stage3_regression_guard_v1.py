#!/usr/bin/env python3
"""Stage-3 regression guard against frozen Stage-3 baseline summary."""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Run Stage-3 regression guard against frozen baseline.")
