...
DEFAULT_OUT_DIR = (
    ...
    / "evidence"
    / "artifacts"
    / "gr-stage2-g11-g12-candidate-eval-v1"
)

# Frozen candidate constants
G11_SPEARMAN_MIN = 0.20
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--g11-spearman-min", type=float, default=G11_SPEARMAN_MIN)
...
def g11_candidate_from_einstein(
    ...
    pass_rule = (
        (not math.isnan(sp_full))
        and (not math.isnan(sp_hs))
        and (abs(sp_full) >= spearman_min)
        and (abs(sp_hs) >= spearman_min)
    )
    return {
        "n_points": n,
...
def main() -> int:
    ...
    for row in src_rows:
        ...
        g11_diag = g11_candidate_from_einstein(
            ...
            spearman_min=args.g11_spearman_min,
        ...
        g11a_v2 = "pass" if (
            ...
            or (
                ...
                and g11c_v1 == "pass"
                and g11d_v1 == "pass"
                and bool(g11_diag["spearman_rule_pass"])
            )
        ) else "fail"
        ...
        out_rows.append(
            {
                ...
                "g11_spearman_rule_pass": "true" if bool(g11_diag["spearman_rule_pass"]) else "false",
    ...
    report_lines = [
        "# GR Stage-2 G11/G12 Candidate Evaluation (v1)",
        "",
    ...
    manifest = {
        ...
        "constants": {
            "g11_spearman_min": args.g11_spearman_min,
