#!/usr/bin/env python3
"""
Run G18 candidate-v3 generalized evaluation on frozen QM Stage-1 summaries.
...
- update G18d only:
  ...
  - if G18d-v1 fails -> evaluate local spectral dimension on two peak basins
    and use robust aggregate (median)
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Run QM G18 candidate-v3 generalized evaluation.")
...
def main() -> int:
        ...
        if g18d_v1 == "pass":
            ...
            if vals:
                ...
                if ds_lo < ds_local_agg < ds_hi:
                    g18d_v2 = "pass"
                    g18d_rule = "local_ds_recovery_generalized"
                else:
                    g18d_v2 = "fail"
    ...
    report_lines = [
        ...
        "## Pass Counts",
        "",
        f"- G18 v1 -> v3: `{g18_v1_pass}/{n} -> {g18_v2_pass}/{n}`",
        ...
        "- G18d-v3 applies local spectral-dimension recovery on all G18d-v1 fail cases.",
    ...
    manifest = {
        ...
        "profiles": n,
        "policy_id": "qm-g18-candidate-v3-local-ds-generalized",
        "mix_ratio_threshold": args.mix_ratio_threshold,
        "mix_distance_threshold": args.mix_distance_threshold,
        ...
        "notes": [
            ...
            "Candidate is governance-layer generalized local-ds recovery.",
        ],
    }
