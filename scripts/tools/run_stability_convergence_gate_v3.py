...
DEFAULT_OUT_DIR = ROOT / "05_validation" / "evidence" / "artifacts" / "stability-convergence-v3"
DEFAULT_PREREG = ROOT / "05_validation" / "pre-registrations" / "qng-stability-convergence-v3.md"
...
def main() -> int:
    ...
    for seed in seeds:
        ...
        for n in levels:
            ...
            eligible = [
                r for r in sub
                if is_pass_flag(r.get(args.bulk_flag_active, ""))
        ...
        seed_rows.append(
            {
                ...
                "rho_bulk": f"{rho_bulk:.6f}" if bulk_support_ok else "",
