#!/usr/bin/env python3
"""
Evaluate D4 Stage-2 candidate formulas v4 on multi-split strict criteria.
"""
...
DEFAULT_PER_SEED = (
    ...
    / "evidence"
    / "artifacts"
    / "d4-stage2-dual-kernel-v4-candidates"
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Evaluate D4 Stage-2 candidates v4 strict multi-split criteria.")
...
def main() -> int:
    ...
    lines = [
        "# D4 Stage-2 Candidate Evaluation v4",
        "",
