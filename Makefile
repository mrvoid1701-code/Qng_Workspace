...
help:
	...
	@echo "  make d4_stage2_winner_v8_run"
	@echo "  make d4_stage2_winner_v8_equiv"
	@echo "  make d4_stage2_winner_v8_eval"
	@echo "  make d4_stage2_winner_v8_pack"
	@echo "  make d4_stage2_winner_v9_run"
	@echo "  make d4_stage2_winner_v9_equiv"
	@echo "  make d4_stage2_winner_v9_eval"
	@echo "  make d4_stage2_winner_v9_forensics_3403"
	@echo "  make d4_stage2_winner_v9_pack"
	@echo "  make d4_stage2_winner_v10_run"
	...
	@echo "  make d4_stage2_winner_v12_run"
	@echo "  make d4_stage2_winner_v12_eval"
	@echo "  make d4_stage2_winner_v12_compare_v11"
	@echo "  make d4_stage2_winner_v12_pack"
...
d4_stage2_winner_v8_run:
	$(PYTHON) scripts/run_d4_stage2_winner_v8_strict.py --test-id d4-stage2-winner-v8-strict --dataset-id DS-006 --dataset-csv data/rotation/rotation_ds006_rotmod.csv --split-seeds 3401,3402,3403,3404,3405 --train-frac 0.70 --s1-lambda 0.28 --s2-const 0.355 --r0-kpc 1.0 --r-tail-kpc 4.0 --tau-grid 0.02,0.05,0.1,0.2,0.3,0.5,1,2,3,5,8,12,20,30,50 --alpha-grid 0.02,0.05,0.1,0.2,0.3,0.5,0.7,1.0,1.3 --focus-gamma 2.0 --candidate winner_v1_m8c --outdir 05_validation/evidence/artifacts/d4-stage2-winner-v8-strict --write-artifacts --no-plots

d4_stage2_winner_v8_equiv:
	$(PYTHON) scripts/tools/check_d4_stage2_winner_v8_equivalence_v1.py --dataset-csv data/rotation/rotation_ds006_rotmod.csv --per-seed-csv 05_validation/evidence/artifacts/d4-stage2-winner-v8-strict/per_seed_candidate_summary.csv --train-frac 0.70 --candidate winner_v1_m8c --tol 1e-4 --out-dir 05_validation/evidence/artifacts/d4-stage2-winner-v8-strict/equivalence-v1

d4_stage2_winner_v8_eval:
	$(PYTHON) scripts/tools/evaluate_d4_stage2_dual_kernel_candidates_v5.py --per-seed-csv 05_validation/evidence/artifacts/d4-stage2-winner-v8-strict/per_seed_candidate_summary.csv --manifest-json 05_validation/evidence/artifacts/d4-stage2-winner-v8-strict/manifest.json --out-dir 05_validation/evidence/artifacts/d4-stage2-winner-v8-strict/evaluation-v1 --expected-test-id d4-stage2-winner-v8-strict --expected-candidates winner_v1_m8c --expected-grid-selection-objective winner_v1_direct_fit --min-holdout-improve-vs-null-pct 10 --max-holdout-mond-worse-pct 0 --max-generalization-gap-pp 20 --max-holdout-delta-aic-dual-minus-mond 0 --max-holdout-delta-bic-dual-minus-mond 0

d4_stage2_winner_v8_pack: d4_stage2_winner_v8_run d4_stage2_winner_v8_equiv d4_stage2_winner_v8_eval

d4_stage2_winner_v9_run:
	$(PYTHON) scripts/run_d4_stage2_winner_v8_strict.py --test-id d4-stage2-winner-v9-strict --dataset-id DS-006 --dataset-csv data/rotation/rotation_ds006_rotmod.csv --split-seeds 3401,3402,3403,3404,3405 --train-frac 0.70 --s1-lambda 0.28 --s2-const 0.355 --r0-kpc 1.0 --r-tail-kpc 4.0 --tau-grid 0.02,0.05,0.1,0.2,0.3,0.5,1,2,3,5,8,12,20,30,50 --alpha-grid 0.02,0.05,0.1,0.2,0.3,0.5,0.7,1.0,1.3 --focus-gamma 2.0 --candidate winner_v1_m8c --outdir 05_validation/evidence/artifacts/d4-stage2-winner-v9-strict --write-artifacts --no-plots

d4_stage2_winner_v9_equiv:
	$(PYTHON) scripts/tools/check_d4_stage2_winner_v8_equivalence_v1.py --dataset-csv data/rotation/rotation_ds006_rotmod.csv --per-seed-csv 05_validation/evidence/artifacts/d4-stage2-winner-v9-strict/per_seed_candidate_summary.csv --train-frac 0.70 --candidate winner_v1_m8c --tol 1e-4 --out-dir 05_validation/evidence/artifacts/d4-stage2-winner-v9-strict/equivalence-v1

d4_stage2_winner_v9_eval:
	$(PYTHON) scripts/tools/evaluate_d4_stage2_dual_kernel_candidates_v5.py --per-seed-csv 05_validation/evidence/artifacts/d4-stage2-winner-v9-strict/per_seed_candidate_summary.csv --manifest-json 05_validation/evidence/artifacts/d4-stage2-winner-v9-strict/manifest.json --out-dir 05_validation/evidence/artifacts/d4-stage2-winner-v9-strict/evaluation-v1 --expected-test-id d4-stage2-winner-v9-strict --expected-candidates winner_v1_m8c --expected-grid-selection-objective winner_v1_direct_fit --min-holdout-improve-vs-null-pct 10 --max-holdout-mond-worse-pct 0 --max-generalization-gap-pp 20 --max-holdout-delta-aic-dual-minus-mond 0 --max-holdout-delta-bic-dual-minus-mond 0

d4_stage2_winner_v9_forensics_3403:
	$(PYTHON) scripts/tools/analyze_d4_stage2_winner_v9_forensics_v1.py --dataset-csv data/rotation/rotation_ds006_rotmod.csv --dataset-id DS-006 --seed 3403 --train-frac 0.70 --out-dir 05_validation/evidence/artifacts/d4-stage2-winner-v9-forensics-seed3403-v1

d4_stage2_winner_v9_pack: d4_stage2_winner_v9_run d4_stage2_winner_v9_equiv d4_stage2_winner_v9_eval d4_stage2_winner_v9_forensics_3403

d4_stage2_winner_v10_run:
	$(PYTHON) scripts/run_d4_stage2_winner_v10_strict.py --test-id d4-stage2-winner-v10-strict --dataset-id DS-006 --dataset-csv data/rotation/rotation_ds006_rotmod.csv --split-seeds 3401,3402,3403,3404,3405 --train-frac 0.70 --s1-lambda 0.28 --s2-const 0.355 --r0-kpc 1.0 --r-tail-kpc 4.0 --tau-grid 0.02,0.05,0.1,0.2,0.3,0.5,1,2,3,5,8,12,20,30,50 --alpha-grid 0.02,0.05,0.1,0.2,0.3,0.5,0.7,1.0,1.3 --focus-gamma 2.0 --candidate winner_v1_m8c --outdir 05_validation/evidence/artifacts/d4-stage2-winner-v10-strict --write-artifacts --no-plots

d4_stage2_winner_v10_eval:
	$(PYTHON) scripts/tools/evaluate_d4_stage2_dual_kernel_candidates_v5.py --per-seed-csv 05_validation/evidence/artifacts/d4-stage2-winner-v10-strict/per_seed_candidate_summary.csv --manifest-json 05_validation/evidence/artifacts/d4-stage2-winner-v10-strict/manifest.json --out-dir 05_validation/evidence/artifacts/d4-stage2-winner-v10-strict/evaluation-v1 --expected-test-id d4-stage2-winner-v10-strict --expected-candidates winner_v1_m8c --expected-grid-selection-objective winner_v1_weighted_lowacc_outer --min-holdout-improve-vs-null-pct 10 --max-holdout-mond-worse-pct 0 --max-generalization-gap-pp 20 --max-holdout-delta-aic-dual-minus-mond 0 --max-holdout-delta-bic-dual-minus-mond 0

d4_stage2_winner_v10_compare_v9:
...
d4_stage2_winner_v12_run:
	$(PYTHON) scripts/run_d4_stage2_winner_v12_strict.py --test-id d4-stage2-winner-v12-strict --dataset-id DS-006 --dataset-csv data/rotation/rotation_ds006_rotmod.csv --split-seeds 3401,3402,3403,3404,3405 --train-frac 0.70 --s1-lambda 0.28 --s2-const 0.355 --r0-kpc 1.0 --r-tail-kpc 4.0 --tau-grid 0.02,0.05,0.1,0.2,0.3,0.5,1,2,3,5,8,12,20,30,50 --alpha-grid 0.02,0.05,0.1,0.2,0.3,0.5,0.7,1.0,1.3 --focus-gamma 2.0 --galaxy-trim-frac 0.10 --candidate winner_v1_m8c --outdir 05_validation/evidence/artifacts/d4-stage2-winner-v12-strict --write-artifacts --no-plots

d4_stage2_winner_v12_eval:
	$(PYTHON) scripts/tools/evaluate_d4_stage2_dual_kernel_candidates_v5.py --per-seed-csv 05_validation/evidence/artifacts/d4-stage2-winner-v12-strict/per_seed_candidate_summary.csv --manifest-json 05_validation/evidence/artifacts/d4-stage2-winner-v12-strict/manifest.json --out-dir 05_validation/evidence/artifacts/d4-stage2-winner-v12-strict/evaluation-v1 --expected-test-id d4-stage2-winner-v12-strict --expected-candidates winner_v1_m8c --expected-grid-selection-objective winner_v1_weighted_lowacc_outer_galaxy_trimmed_mean --min-holdout-improve-vs-null-pct 10 --max-holdout-mond-worse-pct 0 --max-generalization-gap-pp 20 --max-holdout-delta-aic-dual-minus-mond 0 --max-holdout-delta-bic-dual-minus-mond 0

d4_stage2_winner_v12_compare_v11:
