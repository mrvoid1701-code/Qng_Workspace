...
5. Keep Stage-3 official baseline/guard frozen (`gr-stage3-g11g12-v2-official`) and enforce non-regression checks on reruns.
6. Close remaining Stage-3 candidate fail classes (`3/600` after candidate-v3) via preregistered estimator hardening (no threshold tuning).
