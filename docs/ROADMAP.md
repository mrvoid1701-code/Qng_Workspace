...
13. Execute residual Stage-2 closure lane from post-v8 findings (no threshold tuning, degraded=0 required), prioritizing `G18` fail taxonomy then `G17/G19` tails.
