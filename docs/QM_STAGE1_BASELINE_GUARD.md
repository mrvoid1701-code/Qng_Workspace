# QM Stage-1 Baseline + Regression Guard (v9)

This document defines the current QM Stage-1 baseline/guard workflow after the `G18-v7 + G19-v2` official switch.

## Scope

- Lane: QM Stage-1 official (`qm-stage1-g18-v7-g19-v2-official`)
- Blocks:
...
- Official summaries:
  - `05_validation/evidence/artifacts/qm-stage1-official-v11/*/summary.csv`
- Promotion reports:
  - `05_validation/evidence/artifacts/qm-g18-v7-promotion-eval-v1/*/report.json`
- Numeric metrics summaries:
  - `05_validation/evidence/artifacts/qm-g18-candidate-v7/*/summary.csv`
...
- `05_validation/evidence/artifacts/qm-stage1-regression-baseline-v9/qm_stage1_baseline_primary.json`
- `05_validation/evidence/artifacts/qm-stage1-regression-baseline-v9/qm_stage1_baseline_attack.json`
- `05_validation/evidence/artifacts/qm-stage1-regression-baseline-v9/qm_stage1_baseline_holdout.json`
...
- `05_validation/evidence/artifacts/qm-stage1-regression-baseline-v9/latest_check/block_summary.csv`
- `05_validation/evidence/artifacts/qm-stage1-regression-baseline-v9/latest_check/pass_rate_checks.csv`
- `05_validation/evidence/artifacts/qm-stage1-regression-baseline-v9/latest_check/profile_diffs.csv`
- `05_validation/evidence/artifacts/qm-stage1-regression-baseline-v9/latest_check/status_mismatches.csv`
- `05_validation/evidence/artifacts/qm-stage1-regression-baseline-v9/latest_check/regression_report.md`
- `05_validation/evidence/artifacts/qm-stage1-regression-baseline-v9/latest_check/regression_report.json`
